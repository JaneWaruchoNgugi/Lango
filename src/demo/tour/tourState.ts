export const TOUR_STEPS = [
  { title: 'Register a visitor',   body: "A visitor's at the gate. On Visitors, tap “Register a visitor” and fill in the form — they're checked in instantly.", to: '/demo/manager/visitors' },
